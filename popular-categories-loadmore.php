...
<?php $p_c = popular_category_start();?>
    <?php $sliced_array = array_slice($p_c, $start, $end); ?>
                    ...
                    <div class="automobile">
                        <h5 class="auto"><?php echo $category_name; ?></h5>
                            <a href="<?php echo $item_url; ?>">
                                <img src="<?php echo $img_source; ?>" width="240" height="200" class="img-responsive"  title="<?php echo $img_title; ?>" alt="<?php echo $imgtitle; ?>" />
                            </a>
                        <div class="hr"></div>
