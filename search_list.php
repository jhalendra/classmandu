                    ...
                    <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5">
                        ...
                        <?php if(osc_count_premium_resources()) { ?>
                            <a href="<?php echo osc_premium_url() ; ?>">
                                <img src="<?php echo osc_resource_thumbnail_url() ; ?>" title="<?php echo osc_premium_title(); ?>" alt="<?php echo osc_item_title(); ?>" class="img-responsive"/>
                            </a>
                        <?php } else { ?>
    ...
    <?php while(osc_has_items()) { ?>
        <div class="row border-bottom">
            ...
            <div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">   
                <div class="border-line">
                    <ul class="list-inline">
                        <li><h4 class="cat-title"><a href="<?php echo osc_item_url(); ?>"><?php echo osc_highlight( strip_tags( osc_item_title() ) ); ?></a></h4></li>
                        <li style="margin-left:50px;"><span style="color:#7e391a; font-weight:bold;">
                            <?php if( osc_price_enabled_at_items() ) 
                            { 
